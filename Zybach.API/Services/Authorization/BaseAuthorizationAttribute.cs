...
namespace Zybach.API.Services.Authorization
{
    public abstract class BaseAuthorizationAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var dbContextService = context.HttpContext.RequestServices.GetService(typeof(ZybachDbContext));
            if (dbContextService == null || !(dbContextService is ZybachDbContext dbContext))
            {
                //MK 1/16/2018 - If we don't have a repository we are in a terrible state.
                throw new ApplicationException(
                    "Could not find injected ZybachDbRepository. WithRightsAttribute.cs needs your help!");
            }
